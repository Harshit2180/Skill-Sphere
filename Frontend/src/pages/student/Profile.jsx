        ...
        <div className='my-24 mx-auto max-w-4xl px-4'>
                ...
                <div>
                    ...
                    <Dialog>
                        <DialogTrigger asChild>
                            <Button sie="sm" className='mt-2' >Edit Profile</Button>
                        </DialogTrigger>
                        <DialogContent>
                            <DialogHeader>
                            ...
                            <div className='grid gap-4 py-4'>
                                <div className='grid grid-cols-4 items-center gap-4'>
                                    <Label>Name</Label>
                                    <Input type="text" placeholder="Name" value={name} onChange={(e) => setName(e.target.value)} className='col-span-3' />
                                </div>
                                <div className='grid grid-cols-4 items-center gap-4'>
                                    <Label>Profile Photo</Label>
                                    <Input type="file" onChange={onChangeHandler} accep="image/*" className='col-span-3' />
                                </div>
                            </div>
                            <DialogFooter>
            ...
            <div>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 my-4'>
                    {
                        user.enrolledCourses.length === 0 ? <h1>You are not enrolled in any courses yet</h1> : (
