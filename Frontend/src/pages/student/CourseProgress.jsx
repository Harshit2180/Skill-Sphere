...
const CourseProgress = () => {
    ...
    const handleInCompleteCourse = async () => {
        await handleInCompleteCourse(courseId);
    }


    return (
        <div className='max-w7xl mx-auto p-4'>
                    ...
                    <div className='flex-1 overflow-y-auto'>
                        {
                            courseDetails?.lectures.map((lecture) => (
                                <Card key={lecture._id} className={`mb-3 hover:cursor-pointer transition transform ${lecture._id === currentLecture?._id ? "bg-gray-200 dark:dark:bg-gray-800" : ""} `} onClick={() => handleSelectLecture(lecture)}>
